...
export function renderMobile() {
  ...
  mobile.classList = "section";
  mobile.id = "mobile";
  const appStore = `<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
  const googlePlay = `<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M26.0776 23.34L20.9863 18.37V18.0181L26.0837 13.0482L26.1979 13.1128L32.2345 16.4617C33.9573 17.4121 33.9573 18.976 32.2345 19.9324L26.1979 23.2753L26.0776 23.34V23.34Z" fill="#403F3D"/>
<path d="M25.2733 24.2007L20.0617 19.1195L4.68164 34.1166C5.25384 34.7031 6.18695 34.7737 7.24807 34.1873L25.2733 24.2007" fill="#403F3D"/>
...
`;
  ...
  mobile.innerHTML = `
    <div class="mobile-inner">
      <div class="offer">
        <h2 class="h2"><span>Download</span> our app to start ordering</h2>
        <p class="mobile-subtext">Download the Resource app today and experience the comfort of ordering your favorite coffee from wherever you are</p>
        <div class="mobile-buttons">
          <a class="mobile-button" href="https://www.apple.com/app-store/" target="_blank">
            ${appStore}
            <span class="mobile-button-text">
              <span class="caption">Available on</span>
              <span class="mobile-button-title">App Store</span>
            </span>
          </a>
          <a class="mobile-button" href="https://play.google.com/store/apps" target="_blank">
            ${googlePlay}
            <span class="mobile-button-text">
              <span class="caption">Available on</span>
              <span class="mobile-button-title">Google Play</span>
            </span>
          </a>
        </div>
      </div>
      <div>
        <img src="${imagePaths["mobile-screens"]}" alt="mobile app"/>
      </div>
    </div>
  `;
